...
| **Immutable ECR tags**                                                                                           | Prevents a tag from being silently overwritten after deployment — makes GitOps rollback via `git revert` actually trustworthy                                                                     |
